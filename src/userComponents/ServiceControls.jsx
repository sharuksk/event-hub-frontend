...
const ServiceControls = ({ onDatesChange, onSessionChange, onLocationChange }) => {
  ...
  return (
    ...
    >
      <LocalizationProvider dateAdapter={AdapterDayjs}>
        ...
        <Popper open={openCalendar} anchorEl={calendarAnchorEl} placement="bottom-start">
          <Paper>
            <StaticDatePicker
      ...
      <Menu anchorEl={anchorEl} open={Boolean(anchorEl)} onClose={handleMenuClose}>
        {sessions.map((session) => (
          <MenuItem key={session} onClick={() => handleSessionChange(session)}>
            {session}
          </MenuItem>
        ))}
      </Menu>
