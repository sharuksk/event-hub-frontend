...
const OrganizerCard = ({
  ...
  const isSelected = selectedOrganizers.some((o) => o.id === organizer.id);
      ...
      <div className="bg-background/85 text-foreground p-[20px] rounded-[11px] w-[300px] border">
        ...
        >
          ...
          <Box sx={{ textAlign: "left" }}>
            ...
            <Typography variant="body2">{organizer.location}</Typography>
            <Typography variant="body2">Price: {organizer.rent}</Typography>
